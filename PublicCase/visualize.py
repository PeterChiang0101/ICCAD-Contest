...
home = os.path.join(os.getcwd(), "PublicCase")
target = os.path.join(home, "PublicCase_?.txt")
...
path = os.path.join(home, "PublicCase_"+choice+".txt")
silkpath = os.path.join(home, "PublicCase_"+choice+"_Ans.txt")
img_out = os.path.join(home, "PublicCase_"+choice + "_output_new.png")
...
plt.title("PublicCase_" + choice + "_new", color='y')
