...
home = os.path.join(os.getcwd(), "test_case")
target = os.path.join(home, "testcase_?.txt")
...
path = os.path.join(home, "testcase_"+choice+".txt")
silkpath = os.path.join(home, "testcase_"+choice+"_Ans.txt")
img_out = os.path.join(home, "testcase_"+choice + "_output.png")
